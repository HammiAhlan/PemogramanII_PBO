...
{
     class ProductTest_714220062
    {
        static void Main(string[] args)
        {
            Book_714220062 product1 = new Book_714220062("Book", "C# Object Oriented Solution", "300");
            DVD_714220062 product2 = new DVD_714220062(" Eternal Sunshine Of The Spotless Mind", "145");
